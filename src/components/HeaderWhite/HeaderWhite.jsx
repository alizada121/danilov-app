...
import whatlogo from "../../Images/whatlogo.png"
    ...
    return <>
        ...
        {(dimensions.width > 800) && <div className="header"    >
            <ul className="header_ul_one" id="white">
                <a href="https://www.instagram.com/danilov_baku/?hl=en" target="_blank"> <li><img src={insta} className="inst" /></li></a>
                <a href="https://www.facebook.com/Danilov-Shoes-2000969736610486/" target="_blank"><li><img className="fbd" style={{ width: "19px", height: "19px" }} src={fb} /></li></a>

                <Link to="/about">
                    <li className="text text-1">About us</li>
                </Link>
                <Link to="/">
                    <li className="text text-4">Man</li>
                </Link>
            </ul>

            <Link to="/" style={{ width: "205px", height: "" }}>
            ...
            <ul className={!activeWidth ? "active-width" : "header_ul_two"} id="white" ref={refRef} >
                ...
                <div className={activeHeader ? "active-header" : "deactive-header"} >
                    ...
                    <Link to="/newIn" ref={newinRef}>
                        <li className="text text-2" >What’s New</li>
                    </Link>
                    <Link to="/signUp">
                        <li className="text text-3" ref={profileRef}>Profile</li>
                    </Link>
